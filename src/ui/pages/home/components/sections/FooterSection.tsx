...
import { Sparkles, Zap, Users, Target, DollarSign, Shield, FileText } from 'lucide-react';
        ...
        <div className="grid md:grid-cols-5 gap-12 mb-16">
            ...
            <div className="mb-6">
              <div className="flex items-center gap-3 mb-4">
                ...
                <div>
                  ...
                  <p className="text-xs text-gray-500 font-mono">by Modern Teams</p>
                </div>
              </div>
            </div>
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2">
              <li>
                <a href="#" className="group flex items-center gap-2 text-gray-400 hover:text-purple-400 transition-all duration-300 py-1.5 px-2 rounded-lg hover:bg-white/5">
                  <Zap className="w-3.5 h-3.5 opacity-0 group-hover:opacity-100 transition-opacity" />
                  <span className="group-hover:translate-x-1 transition-transform">Ventajas</span>
                </a>
              </li>
              <li>
                <a href="#" className="group flex items-center gap-2 text-gray-400 hover:text-purple-400 transition-all duration-300 py-1.5 px-2 rounded-lg hover:bg-white/5">
              ...
              <li>
                <a href="#" className="group flex items-center gap-2 text-gray-400 hover:text-purple-400 transition-all duration-300 py-1.5 px-2 rounded-lg hover:bg-white/5">
                  ...
                  <span className="group-hover:translate-x-1 transition-transform">Seguridad</span>
                </a>
              </li>
            </ul>
          </div>
          ...
          <div className="space-y-4">
            <div className="flex items-center gap-2 mb-6">
              ...
              <h4 className="font-bold text-white text-sm uppercase tracking-wider">Empresa</h4>
            </div>
            <ul className="space-y-2">
              <li>
                <Link to="/about" className="group flex items-center gap-2 text-gray-400 hover:text-pink-400 transition-all duration-300 py-1.5 px-2 rounded-lg hover:bg-white/5">
              ...
              <li>
                <a href="#" className="group flex items-center gap-2 text-gray-400 hover:text-pink-400 transition-all duration-300 py-1.5 px-2 rounded-lg hover:bg-white/5">
                  <Sparkles className="w-3.5 h-3.5 opacity-0 group-hover:opacity-100 transition-opacity" />
                  <span className="group-hover:translate-x-1 transition-transform">Novedades</span>
                </a>
              </li>
              <li>
                <a href="#" className="group flex items-center gap-2 text-gray-400 hover:text-pink-400 transition-all duration-300 py-1.5 px-2 rounded-lg hover:bg-white/5">
              ...
              <li>
                <Link to="/contact" className="group flex items-center gap-2 text-gray-400 hover:text-pink-400 transition-all duration-300 py-1.5 px-2 rounded-lg hover:bg-white/5">
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2">
              <li>
                <a href="#" className="group flex items-center gap-2 text-gray-400 hover:text-blue-400 transition-all duration-300 py-1.5 px-2 rounded-lg hover:bg-white/5">
                  <Shield className="w-3.5 h-3.5 opacity-0 group-hover:opacity-100 transition-opacity" />
                  <span className="group-hover:translate-x-1 transition-transform text-sm">Protección Infantil</span>
                </a>
              </li>
              <li>
                <a href="#" className="group flex items-center gap-2 text-gray-400 hover:text-blue-400 transition-all duration-300 py-1.5 px-2 rounded-lg hover:bg-white/5">
                  <FileText className="w-3.5 h-3.5 opacity-0 group-hover:opacity-100 transition-opacity" />
                  <span className="group-hover:translate-x-1 transition-transform text-sm">Usuario y Normativa</span>
                </a>
              </li> 
            </ul>
          </div>
