    ...
    <section className="relative py-40 px-6 overflow-hidden bg-black">
      ...
      <div className="container mx-auto max-w-5xl text-center relative z-10">
        <div className="inline-block mb-8 px-6 py-2 bg-white/5 border border-white/10 rounded-full">
          <span className="text-sm font-semibold text-gray-400 uppercase tracking-wider">Impacto & Resultados</span>
        </div>
        
        <h2 className="text-5xl md:text-7xl font-bold mb-8 leading-tight">
          Verla conecta hogares con
        </h2>
        
        <div className="mb-8 relative">
          <span className="text-6xl md:text-8xl font-black text-transparent bg-clip-text animate-gradient inline-block" style={{ backgroundImage: 'linear-gradient(to right, #5B6FFF, #7A8FFF, #4A5CFF, #FFFFFF, #4A5CFF, #7A8FFF, #5B6FFF)', backgroundSize: '200% 100%' }}>
            velocidad real
          </span>
        ...
        <div className="grid md:grid-cols-3 gap-6 mt-16 max-w-4xl mx-auto">
          <div className="relative bg-white/5 border border-white/10 rounded-2xl p-6 backdrop-blur-sm hover:bg-white/10 hover:border-white/20 transition-all duration-300 group overflow-hidden">
            <div className="absolute inset-0 bg-linear-to-br from-[#5B6FFF]/10 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
            <div className="relative text-4xl font-bold text-transparent bg-clip-text bg-linear-to-r from-[#7A8FFF] to-[#4A5CFF] mb-2 group-hover:scale-110 transition-transform">
              100%
            </div>
            <p className="relative text-gray-400 text-sm">Fibra Óptica</p>
          </div>
          ...
          <div className="bg-white/5 border border-white/10 rounded-2xl p-6 backdrop-blur-sm hover:bg-white/10 hover:border-white/20 transition-all duration-300 group">
            ...
            <p className="text-gray-400 text-sm">TV en Alta Definición</p>
          </div>
        </div>
      </div>
    </section>
