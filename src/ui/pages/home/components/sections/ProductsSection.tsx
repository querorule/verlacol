...
const products = [
  {
    ...
    description: 'Conexión de alta velocidad para tu hogar con soporte 24/7 y sin límite de datos.',
  ...
  },
  {
    ...
    description: 'Conexión dedicada para empresas con ancho de banda garantizado y soporte prioritario.',
  ...
  },
  {
    ...
    description: 'Soluciones de almacenamiento y procesamiento en la nube para tu negocio.',
  ...
  },
  {
    ...
    description: 'Diseño e implementación de redes seguras para empresas de todos los tamaños.',
...
const ProductsSection = () => {
  ...
  return (
    <section className={`relative py-20 overflow-hidden ${isDark ? 'bg-gray-950' : 'bg-gray-950'}`}>
      <div className="container px-4 mx-auto">
        <div className="max-w-4xl mx-auto text-center mb-16">
          <motion.span 
            className={`inline-block py-1.5 px-4 mb-4 text-sm font-medium rounded-full ${isDark ? 'text-verla-primary bg-verla-primary/10' : 'text-verla-600 bg-verla-100'}`}
          ...
          >
            Descubre nuestra <span className="text-verla-primary">gama de productos</span>
          </motion.h2>
          <motion.p 
