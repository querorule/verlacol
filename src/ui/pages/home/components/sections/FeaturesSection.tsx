...
const services = [
  ...
  },
  {
    ...
    image: "https://images.unsplash.com/photo-1593784991095-a205069470b6?w=800&h=600&fit=crop&q=80",
    category: "Entertainment",
  },
  {
    id: 4,
    title: "Soporte Técnico",
    description: "Asistencia experta siempre disponible",
        ...
        <div className="grid md:grid-cols-2 gap-6">
          ...
          <div className="space-y-6">
            ...
            <div className="space-y-4">
              ...
              >
                Descubre nuestra gama completa de soluciones de conectividad diseñadas para llevar tu experiencia digital al siguiente nivel
              </p>
            </div>

            {/* Service 1 - Below Text */}
            <div className="group relative rounded-3xl overflow-hidden cursor-pointer transition-all duration-500">
              ...
              <div className="relative rounded-3xl overflow-hidden transform group-hover:scale-[1.02] group-hover:shadow-2xl transition-all duration-500">
                ...
                />
                <div className="absolute inset-0 bg-linear-to-t" style={{
                ...
                <div className="absolute top-4 left-4 transform group-hover:scale-110 transition-transform duration-300">
                  <div className="relative">
                    {/* Glow effect */}
                    <div className="absolute inset-0 rounded-full opacity-50 group-hover:opacity-75 transition-opacity" style={{
                      background: 'linear-gradient(135deg, #5B6FFF, #7A8FFF)',
                      filter: 'blur(8px)'
                    }}></div>
                    
                    <div className="relative flex items-center gap-1.5 px-4 py-2 rounded-full backdrop-blur-md" style={{
                      background: 'linear-gradient(135deg, rgba(91, 111, 255, 0.4), rgba(122, 143, 255, 0.3))',
          ...
          <div className="space-y-6">
            {/* Service 2 - Top Right */}
            <div className="group relative rounded-3xl overflow-hidden cursor-pointer transition-all duration-500">
              <div className="absolute -inset-0.5 rounded-3xl opacity-0 group-hover:opacity-100 transition-opacity duration-500" style={{
              ...
              <div className="relative rounded-3xl overflow-hidden transform group-hover:scale-[1.02] group-hover:shadow-2xl transition-all duration-500">
                ...
                <div className="absolute top-3 left-3 transform group-hover:scale-110 transition-transform duration-300">
                  <div className="relative">
                    ...
                    <div className="relative flex items-center gap-1.5 px-3 py-1.5 rounded-full backdrop-blur-md" style={{
                      background: 'linear-gradient(135deg, rgba(122, 143, 255, 0.4), rgba(91, 111, 255, 0.3))',
                      border: '1px solid rgba(255, 255, 255, 0.3)',
                ...
                <div className="relative rounded-3xl overflow-hidden transform group-hover:scale-[1.03] group-hover:shadow-xl transition-all duration-500">
                  ...
                  <div className="absolute top-2 left-2 transform group-hover:scale-110 transition-transform duration-300">
                    <div className="relative">
                      ...
                      <div className="relative flex items-center gap-1 px-2.5 py-1 rounded-full backdrop-blur-md" style={{
                        background: 'linear-gradient(135deg, rgba(74, 92, 255, 0.4), rgba(122, 143, 255, 0.3))',
                        border: '1px solid rgba(255, 255, 255, 0.3)',
                        boxShadow: '0 3px 10px rgba(74, 92, 255, 0.2)'
                      }}>
                        <div className="w-1 h-1 rounded-full animate-pulse" style={{ background: '#FFFFFF' }}></div>
                        <span className="text-xs font-black uppercase tracking-wider" style={{ 
                          color: '#FFFFFF',
                          textShadow: '0 2px 4px rgba(0,0,0,0.3)',
                          fontSize: '9px'
                ...
                <div className="relative rounded-3xl overflow-hidden transform group-hover:scale-[1.03] group-hover:shadow-xl transition-all duration-500">
                  ...
                  <div className="absolute top-2 left-2 transform group-hover:scale-110 transition-transform duration-300">
                    <div className="relative">
                      ...
                      <div className="relative flex items-center gap-1 px-2.5 py-1 rounded-full backdrop-blur-md" style={{
                        background: 'linear-gradient(135deg, rgba(91, 111, 255, 0.4), rgba(74, 92, 255, 0.3))',
                        border: '1px solid rgba(255, 255, 255, 0.3)',
                        boxShadow: '0 3px 10px rgba(91, 111, 255, 0.2)'
                      }}>
                        <div className="w-1 h-1 rounded-full animate-pulse" style={{ background: '#FFFFFF' }}></div>
                        <span className="text-xs font-black uppercase tracking-wider" style={{ 
                          color: '#FFFFFF',
